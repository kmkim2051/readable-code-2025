...
public class HourlyPassTypeRunner extends StudyCafeTypeRunner {
  ...
  public HourlyPassTypeRunner(StudyCafeFileHandler studyCafeFileHandler,
  ...
  public StudyCafePassList getFilteredPasses() {
    StudyCafePassList studyCafePasses = studyCafeFileHandler.readStudyCafePasses();
    return studyCafePasses.getSelectedPasses(PASS_TYPE);
  }
